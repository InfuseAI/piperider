...
class DbtUtility:
    ...
    def search_dbt_project_path():
        ...
        DbtUtility._warning_if_search_path_too_widely(os.getcwd())
    ...
    def append_descriptions(profile_result, dbt_state_dir, default_schema):
        run_results = DbtUtility._get_state_run_results(dbt_state_dir)
        manifest = DbtUtility._get_state_manifest(dbt_state_dir)
    ...
    def get_dbt_state_tests_result(dbt_state_dir: str, default_schema: str):
        ...
        for result in run_results.get('results', []):
            ...
            for depends_on_node_id in depends_on_nodes:
                ...
                table = depends_on_node.get('alias') if depends_on_node.get('alias') else depends_on_node.get('identifier')
                break
