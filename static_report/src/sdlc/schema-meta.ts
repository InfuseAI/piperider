export const schemaMetaDescriptions = {
  ...
  min: "The minimum value of a column's range; can be numerical or datetime string",
  max: "The maximum value of a columns's range; can be numerical or datetime string",
